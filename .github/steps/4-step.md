...
1. **Copilot Chat** パネルを開き、**Plan Agent** に切り替えます。
   ...
   <img width="350" alt="image" src="https://github.com/naoyajojo-png/skills-getting-started-with-github-copilot/blob/main/.github/images/plan-mode-dropdown.png?raw=true" />
...
1. 提案された計画を確認し、納得できたら **Start implementation** をクリックして **Agent Mode** に引き渡します。
   ...
   <img width="350" alt="image" src="https://github.com/naoyajojo-png/skills-getting-started-with-github-copilot/blob/main/.github/images/plan-mode-start-implementation.png?raw=true" />
